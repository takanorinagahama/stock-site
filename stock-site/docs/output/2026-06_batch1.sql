-- ============================================================
-- AI銘柄データ投入 SQL  Batch 1/3（銘柄 1〜20社）
...
VALUES
  ...
  ('AMZN', 'Amazon.com Inc.', 'US', 'NASDAQ', 'ai cloud',
   ...
   'AWS上でBedrock（生成AI基盤）やSageMakerなどのAIサービスを提供し、法人向けAIクラウド市場の重要プレイヤーとなっている。独自のTrainium2チップ開発でAI学習コストの削減とサービス競争力の強化を進めており、設備投資額が業界でも屈指の規模となっている。',
   2, 2, '中程度', true),

  ('META', 'Meta Platforms Inc.', 'US', 'NASDAQ', 'ai application',
   'FacebookやInstagramなどのSNSを運営する広告収益主体のIT企業。月間利用者数が30億人超の規模を持ち、広告配信の精度向上にAIを積極活用している。Llama 4シリーズのオープンソース公開でAI研究コミュニティへの貢献でも知られる。',
  ...
  ('SMCI', 'Super Micro Computer Inc.', 'US', 'NASDAQ', 'ai servers/hpc',
   ...
   'AIデータセンター向けGPUサーバーをフルラック単位で提供し、納期の速さと液冷対応が評価されている。AIサーバーへの設備投資が増えるほど同社への発注が増えやすい構造にある一方、会計問題への対応や競合激化が引き続き注目点となっている。',
   3, 3, '高い', true),

  ('ASML', 'ASML Holding N.V.', 'US', 'NASDAQ', 'semiconductor manufacturing equipment',
   'EUV（極紫外線）リソグラフィ装置を世界で唯一製造する半導体装置企業。TSMC・Samsung・Intelなど先端ロジック半導体メーカー向けに、最小線幅のチップ製造に必要な露光装置を供給している。次世代High-NA EUV装置の受注も進めている。',
   'EUV装置は先端AIチップの微細化製造に必要であり、TSMCなどがAI需要に応じて生産能力を拡大する際に同社への発注が増えやすい。製造リードタイムが長いため需要の波及に時間差が生じるが、中長期の受注見通しは堅調に推移している。',
   2, 2, '中程度', true),

  ('AMAT', 'Applied Materials Inc.', 'US', 'NASDAQ', 'semiconductor manufacturing equipment',
   '成膜・エッチング・CMP・検査など幅広い半導体製造プロセス装置を手がける装置メーカー。ロジック・メモリ・先端パッケージングの各分野に製品を供給し、製造ライン全体の広い範囲をカバーする。',
  ...
  ('LRCX', 'Lam Research Corporation', 'US', 'NASDAQ', 'semiconductor manufacturing equipment',
   'エッチングおよびCVD（化学気相成長）装置を中心とした半導体製造装置メーカー。3D NAND・HBMなどのメモリ製造と先端ロジックチップの微細加工の両方に装置を供給している。',
  ...
  ('INTC', 'Intel Corporation', 'US', 'NASDAQ', 'semiconductor',
   'CPUの設計・製造を一体で行う半導体企業。データセンター・PC・IoT向けにXeonおよびCoreシリーズCPUを展開しており、ファウンドリ（受託製造）事業への参入を模索している。AIアクセラレータ「Gaudi」シリーズでGPU市場への参入を試みているが、競合との差は大きい。',
   'Gaudi AIアクセラレータをデータセンター向けに提供しているが、NVIDIAやAMDとの競争力の差が大きく採用事例は限定的にとどまっている。ファウンドリ事業は外部顧客獲得に苦戦しており、事業再建に向けた取り組みが続いている。',
   1, 1, '低い', true),
  ...
  ('DELL', 'Dell Technologies Inc.', 'US', 'NYSE', 'ai servers/storage',
   ...
   'NVIDIAのGPUを搭載したAIサーバーをエンタープライズ企業向けに提供しており、企業のAIインフラ投資が増えるほどISG（インフラソリューション）部門の恩恵を受けやすい。AIサーバーの受注残が積み上がっており、AI設備投資サイクルの恩恵を受けやすい立場にある。',
   2, 2, '中程度', true),
  ...
  ('CRM', 'Salesforce Inc.', 'US', 'NYSE', 'enterprise ai software',
   '顧客管理（CRM）クラウドソフトウェアの大手企業。営業・マーケティング・カスタマーサービス向けのSaaSを大企業から中小企業まで幅広く提供している。AgentforceというAIエージェント製品を積極展開しており、企業向けAI自動化の分野で存在感を高めている。',
   'AgentforceはAIエージェントが顧客対応や営業タスクを自律的に処理するプラットフォームで、既存のCRM契約顧客へのアドオン販売として展開されている。Data Cloudとの連携でAI推論精度が上がり、AI機能の付加価値が収益拡大につながりやすい構造がある。',
   2, 2, '中程度', true),

  ('ORCL', 'Oracle Corporation', 'US', 'NYSE', 'ai cloud',
   'データベースソフトウェアで業務基盤を支えてきたIT企業で、近年はOCI（Oracle Cloud Infrastructure）へのクラウド転換を進めている。MicrosoftやOpenAIなど大手との大規模GPU契約を積み上げ、AIクラウドインフラの重要プレイヤーとして急浮上している。',
   'OCIのGPUクラスターがMicrosoftなどAI大手との大口契約で稼働しており、AIクラウドインフラの提供者として存在感を高めている。大規模GPUクラスターを必要とするAI学習需要の取り込みが、クラウド部門の高成長を支えている。',
   2, 2, '中程度', true),
  ...
  ('QCOM', 'Qualcomm Incorporated', 'US', 'NASDAQ', 'semiconductor',
   ...
   'Snapdragonシリーズに内蔵されたNPU（AI演算ユニット）がスマートフォン・AI PC上でのオンデバイスAI推論を担っており、AI機能の普及がSnapdragon搭載端末の需要増につながりやすい。クラウド非依存のエッジAI処理は低遅延・プライバシーの観点から採用が広がっている。',
   2, 2, '中程度', true)
...
VALUES
  ...
  ('NVDA', '2026-06', '2026-06', 'A',
   140000, 140000, 140000,
   100, 95, 98, 95, 97),

  -- MSFT: (83+86+72+90)/4 = 83
  ('MSFT', '2026-06', '2026-06', 'A',
   40000, 40000, 40000,
   83, 86, 72, 90, 83),

  -- GOOGL: (86+82+76+88)/4 = 83
  ('GOOGL', '2026-06', '2026-06', 'B',
   48000, 48000, 48000,
   86, 82, 76, 88, 83),

  -- AMZN: (84+83+68+90)/4 = 81
  ('AMZN', '2026-06', '2026-06', 'A',
   42000, 42000, 42000,
   84, 83, 68, 90, 81),

  -- META: (73+86+65+80)/4 = 76
  ('META', '2026-06', '2026-06', 'B',
   11000, 11000, 11000,
   73, 86, 65, 80, 76),

  -- AMD: (76+82+82+85)/4 = 81
  ('AMD', '2026-06', '2026-06', 'B',
   5500, 5500, 5500,
   76, 82, 82, 85, 81),

  -- AVGO: (85+88+88+90)/4 = 88
  ('AVGO', '2026-06', '2026-06', 'A',
   18000, 18000, 18000,
   85, 88, 88, 90, 88),

  -- TSM: (90+92+90+92)/4 = 91
  ('TSM', '2026-06', '2026-06', 'A',
   38000, 38000, 38000,
   90, 92, 90, 92, 91),

  -- MU: (80+82+82+85)/4 = 82
  ('MU', '2026-06', '2026-06', 'B',
   14000, 14000, 14000,
   80, 82, 82, 85, 82),

  -- SMCI: (80+80+90+72)/4 = 81
  ('SMCI', '2026-06', '2026-06', 'B',
   16000, 16000, 16000,
   80, 80, 90, 72, 81),

  -- ASML: (76+72+65+82)/4 = 74
  ('ASML', '2026-06', '2026-06', 'B',
   9000, 9000, 9000,
   76, 72, 65, 82, 74),

  -- AMAT: (73+70+60+80)/4 = 71
  ('AMAT', '2026-06', '2026-06', 'B',
   7500, 7500, 7500,
   73, 70, 60, 80, 71),

  -- LRCX: (68+66+58+78)/4 = 68
  ('LRCX', '2026-06', '2026-06', 'B',
   4200, 4200, 4200,
   68, 66, 58, 78, 68),

  -- KLAC: (65+63+55+75)/4 = 65
  ('KLAC', '2026-06', '2026-06', 'B',
   2700, 2700, 2700,
   65, 63, 55, 75, 65),

  -- INTC: (42+48+42+62)/4 = 49
  ('INTC', '2026-06', '2026-06', 'C',
   1800, 1800, 1800,
   42, 48, 42, 62, 49),

  -- DELL: (66+72+50+75)/4 = 66
  ('DELL', '2026-06', '2026-06', 'B',
   11000, 11000, 11000,
   66, 72, 50, 75, 66),

  -- HPE: (58+63+52+72)/4 = 61
  ('HPE', '2026-06', '2026-06', 'B',
   3200, 3200, 3200,
   58, 63, 52, 72, 61),

  -- CRM: (66+74+68+80)/4 = 72
  ('CRM', '2026-06', '2026-06', 'B',
   5500, 5500, 5500,
   66, 74, 68, 80, 72),

  -- ORCL: (70+78+62+82)/4 = 73
  ('ORCL', '2026-06', '2026-06', 'B',
   12000, 12000, 12000,
   70, 78, 62, 82, 73),

  -- QCOM: (56+63+55+72)/4 = 62
  ('QCOM', '2026-06', '2026-06', 'B',
   1600, 1600, 1600,
   56, 63, 55, 72, 62)
